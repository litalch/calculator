...
describe('calculateNextState', function() {
	...
	it('should return valid json , display should be the current input ,part2,action should be empty , on receiving input number after =', () => {
		expect(calculator.calculateNextState({display: "15" , part1: "15" ,part2:"", "action":""},"7"))
		.to.include({display: "7" , part1: "7" ,part2: "", "action":""});
	})

	it('should return ERR on receiving input + at the begining', () => {
		expect(calculator.calculateNextState(null,"+")).to.equal("ERR");
	})
	...
	it('should return ERR on receiving input + after -', () => {
		expect(calculator.calculateNextState({display: "15" , part1: "15" ,part2:"", "action":"-"},"+")).to.equal("ERR");
	})
